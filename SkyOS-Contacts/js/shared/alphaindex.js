...
(function(global) {
  var primaryDict = {
    '0': '0+ ',
    '1': '1.,?!;:_/@-=',
    '2': '2abcабвгґäçàâáăāĉčąćѓəғαβγάაბგდաբգդדהו',
    '3': '3defдеёєжзëæéèêðďěęėēђđз́ѕδεζέევზთեզէըאבג',
    '4': '4ghiиіїйклïîíįīĝğģĥљќқѝηθιήίϊΐიკლმթժիլխמםנן',
    '5': '5jklмнопĵķļľłњңөκλμნოპჟծկհձղיכךל',
    '6': '6mnoрстуåöôøñňņóòơńћўүұνξοόრსტუճմյնշזחט',
    '7': '7pqrsфхцчßřŕšŝśşșџһπρσςფქღყոչպջռרשת',
    '8': '8tuvшщъыťțüùûúŭūųůưþτυφύϋΰშჩცძսվտրցצץק',
    '9': '9wxyzьэюяÿýžźżχψωώწჭხჯჰւփքօֆևסעפף'
