...
(function(global, nav) {
  ...
  var LCOBJ = {
    ...
    'he': {
      'No valid SIMs': 'אין כרטיסי SIM זמינים',
      'Call failed, connection unavailable': 'אין קליטה',
      'Cancel': 'ביטול',
      'Options': 'אפשרויות',
      'USE': 'שימוש',
      'SELECT': 'בחירה',
      ...
      'CALL': 'שיחה',
      'SMS': 'הודעה',
      'Contacts reindexed': 'האינדקס נוצר מחדש',
      'No numbers assigned to the contact, call impossible': 'אי אפשר לחייג לאיש קשר ללא מספר',
      'No numbers assigned to the contact, SMS impossible': 'אי אפשר לשלוח הודעה לאיש קשר ללא מספר',
      'Contact saved': 'איש הקשר נשמר',
      'Delete the contact $1? This action cannot be undone!': 'למחוק את $1? הפעולה לא ניתנת לביטול!',
      'Contact deleted': 'איש הקשר נמחק',
      'Name': 'שם',
      'Phone': 'טלפון',
      'Save to SIM? Only the first entered number will be saved!': 'לשמור בSIM? רק מספר הטלפון הראשון ישמר!',
      'Save to device': 'שמור במכשיר',
      'Save to SIM': 'שמור בSIM',
      'Exit': 'יציאה',
      'Reindex': 'צור את האינדקס מחדש',
      'Message': 'שלח הודעה',
      'About': 'אודות',
      'New': 'חדש',
      'Edit': 'ערוך',
      'Delete': 'מחק',
      'Close without saving?': 'לצאת ללא שמירה?',
      'No phones found in the contact': 'לא נמצאו מספרי טלפון לאיש קשר זה',
      'Indexing, please wait...': 'יוצר את האינדקס, אנא המתן...'
    },
    'tpl': {
      'No valid SIMs': '',
      'Call failed, connection unavailable': '',
